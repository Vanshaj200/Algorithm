      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            Welcome to the Celestial AI Space Data Dashboard
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest data processing and analysis activities
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Exoplanet detection completed</p>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Light curve data uploaded</p>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Anomaly detection in progress</p>
